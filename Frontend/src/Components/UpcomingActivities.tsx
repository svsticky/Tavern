...
export default defineComponent({
    ...
    setup(props) {
        ...
        const updateVisible = () => {
            ...
            const tileWidth = 200;
            const possibleTileBesidesEachother = Math.floor(containerWidth / tileWidth);
            comingActivitiesBelowEachother.value = possibleTileBesidesEachother === 1;
            const count = comingActivitiesBelowEachother.value ? 3 : possibleTileBesidesEachother;
        ...
        return () => (
            <div ref={containerRef} class={cn("flex p-2 gap-5", comingActivitiesBelowEachother.value ? "flex-col" : "flex-row")}>
