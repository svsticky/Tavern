...
import { CircleCheckBig, TrendingUp, Clock, Calendar, UsersRound } from "lucide-vue-next";
                        ...
                        < Tile class="flex flex-col gap-4 bg-(--theme-460) border-2 border-white/20 grow basis-0">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                {props.nextActivity.maxParticipants
                                    ? props.nextActivity.maxParticipants - props.nextActivity.numberOfParticipants
                                    : 0}{" "}
