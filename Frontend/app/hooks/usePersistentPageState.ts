 ...
 * across navigations, keyed by pathname, and hands it back on a genuine back
 * navigation instead of resetting to defaults and re-fetching. Seed state
 * from `initial`, skip fetching when `isRestored`, and call `save(...)` once
 * loading finishes.
 */
