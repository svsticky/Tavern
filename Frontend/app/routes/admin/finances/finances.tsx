...
import { type Activity, type ActivityResponseDto, type EnrollmentBalance, type Member } from "~/api";
                ...
                <div className="flex flex-col sm:flex-row items-end gap-2">
                    ...
                    <div className="w-full sm:w-auto">
                        <Button 
                            ...
                            onClick={() => handlePaymentsExport(exportStartDate, exportEndDate, setExporting)}
                        >
                            {t("export")}{exporting && "..."}
                        </Button>
                    </div>
                                                ...
                                                <div key={member.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 border border-slate-100 rounded-xl gap-3">
                                                    ...
                                                    <div className="w-full sm:w-auto">
                                                            ...
                                                            onClick={() =>
                                                              handleMarkAsPaid({
                                                                member,
                                                                enrollments: memberWithOverduePayment.enrollments,
                                                                setLoading,
                                                                refreshUnpaid: () =>
                                                                  refreshUnpaidPayments({
                                                                    setUnpaidBalances,
