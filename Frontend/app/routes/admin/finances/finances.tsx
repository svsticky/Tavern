...
export default function Finances() {
  ...
  const skipFinancesFetchRef = useRef(isRestored);
  const skipExpiredFetchRef = useRef(isRestored);

  useEffect(() => {
    if (skipFinancesFetchRef.current) {
      skipFinancesFetchRef.current = false;
      return;
    }
    loadFinancesData({
      setLoading,
  ...
  useEffect(() => {
    if (skipExpiredFetchRef.current) {
      skipExpiredFetchRef.current = false;
      return;
    }
    loadExpiredActivities({
