...
export type SpecificationQuestionDto = {
    questionDutch: string | null;
    questionEnglish: string | null;
    type?: QuestionType;
    isMandatory?: boolean;
...
export type PostApiActivitiesData = {
    ...
    query: {
        ...
        OrganizerId?: number;
        SpecificationQuestions?: Array<SpecificationQuestionDto>;
        ShowInKoala?: boolean;
        ShowOnWebsite?: boolean;
        IsEnrollable?: boolean;
        AreParticipantsVisible?: boolean;
...
export type PatchApiAnnouncementsByIdTitleData = {
    body?: string;
    path: {
        id: number;
    };
...
export type PatchApiAnnouncementsByIdTitleResponses = {
    /**
     * OK
     */
    200: unknown;
...
export type PostApiMembersForgotPasswordData = {
...
export type PostApiMembersForgotPasswordResponses = {
    /**
     * OK
     */
    200: unknown;
...
export type PostApiMembersByIdResendActivationData = {
    body?: never;
    path: {
        id: string;
    };
...
export type PostApiMembersByIdResendActivationResponses = {
    /**
     * OK
     */
    200: unknown;
...
export type PostApiMembersByIdProfilePictureData = {
    body?: {
        image?: Blob | File;
    };
    path: {
...
export type PostApiMembersByIdProfilePictureResponses = {
    /**
     * OK
     */
    200: unknown;
...
export type PostApiRolealiasesResponse = PostApiRolealiasesResponses[keyof PostApiRolealiasesResponses];
...
export type PostApiStudiesResponse = PostApiStudiesResponses[keyof PostApiStudiesResponses];
