...
export const patchApiStudyenrollmentsByIdStatus = <ThrowOnError extends boolean = false>(options: Options<PatchApiStudyenrollmentsByIdStatusData, ThrowOnError>) => (options.client ?? client).patch<PatchApiStudyenrollmentsByIdStatusResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
