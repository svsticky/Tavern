  ...
  const submitProcess = async () => {
    try {
      ...
      if (isEdit) {
        ...
        // Go back to the activity's page instead of replacing this entry -
        // it's already earlier in history, so replacing would duplicate it
        // and make the next "back" press a no-op.
