...
import { type ActivityResponseDto, type GetSpecificationQuestionResponseDto, type GroupResponseDto } from '~/api';
                ...
                <FormSection title={t("specification_questions")} columns={1}>
                    ...
                    {questions.map((q, index) => (
                        <EditQuestionTile 
                            ...
                            onUpdate={(field, value) => updateQuestion(index, field, value, questions, setQuestions)}
                        />
                    ))}
