...
public static class PaymentUtils
{
    ...
    public static IEnumerable<EnrollmentBalance> GetUnpaidEnrollmentsForMember(Member member, PostgresDbContext db)
    {
        return db.Enrollments
            ...
            .Include(e=> e.Member) // Include the Member navigation property to avoid lazy loading issues
            .Include(e => e.Activity) // Include the Activity navigation property to avoid lazy loading issues
            .Select(e => new 
            {
                Enrollment = e,
