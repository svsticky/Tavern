...
public class RegisterReasonServiceTests : IDisposable
{
    ...
    private readonly RegisterReasonService _service;
    private readonly Guid _userId = Guid.NewGuid();

    public RegisterReasonServiceTests()
    {
        ...
        _service = new RegisterReasonService(
            _db,
            _permissionService,
            _fileCompressor,
            _storageService,
            _memoryCache,
            NullLogger<RegisterReasonService>.Instance
        );
    }
    ...
    public async Task GetRegisterReasons_ReturnsSortedReasons()
    {
        ...
        // Act
        var result = await _service.GetRegisterReasons(CancellationToken.None);
    ...
    public async Task GetRegisterReason_Found_ReturnsDto()
    {
        ...
        // Act
        var result = await _service.GetRegisterReason(10, CancellationToken.None);
    ...
    {
        // Act
        var result = await _service.GetRegisterReason(999, CancellationToken.None);
    ...
    public async Task CreateRegisterReason_UserNotBoard_ThrowsUnauthorized()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _service.CreateRegisterReason(dto, _userId, CancellationToken.None));
    }
    ...
    public async Task CreateRegisterReason_WithSortOrder_SavesCorrectly()
    {
        ...
        // Act
        var result = await _service.CreateRegisterReason(dto, _userId, CancellationToken.None);
    ...
    public async Task UpdateRegisterReason_NotFound_ThrowsKeyNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _service.UpdateRegisterReason(999, dto, _userId, CancellationToken.None));
    }
    ...
    public async Task UpdateRegisterReason_UpdatesFields()
    {
        ...
        // Act
        await _service.UpdateRegisterReason(1, dto, _userId, CancellationToken.None);
    ...
    public async Task DeleteRegisterReason_RemovesFromDbAndStorage()
    {
        ...
        // Act
        await _service.DeleteRegisterReason(1, _userId, CancellationToken.None);
    ...
    public async Task UploadRegisterReasonIcon_NullIcon_ClearsIcon()
    {
        ...
        // Act
        var result = await _service.UploadRegisterReasonIcon(1, _userId, null);
    ...
    public async Task UploadRegisterReasonIcon_ValidIcon_SavesAndDeletesOld()
    {
        ...
        // Act
        var result = await _service.UploadRegisterReasonIcon(1, _userId, formFile);
    ...
    public async Task UploadRegisterReasonIcon_CompressThrows_RollsBackTransaction()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(() =>
            _service.UploadRegisterReasonIcon(1, _userId, formFile));
    ...
    public async Task GetRegisterReasonIconFile_Cached_ReturnsCachedFile()
    {
        ...
        // Act
        var result = await _service.GetRegisterReasonIconFile("path.webp");
