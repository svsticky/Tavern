...
public class ProjectionsTests
{
    ...
    public void GroupProjections_ToDto_Works()
    {
        ...
        var dto = GroupProjections.ToDto().Compile()(group);
    ...
    public void SpecificationQuestionProjections_ToDto_Works()
    {
        ...
        var dto = SpecificationQuestionProjections.ToDto().Compile()(question);
    ...
    public void SpecificationAnswerProjections_ToDto_Works()
    {
        ...
        var dto = SpecificationAnswerProjections.ToDto().Compile()(answer);
    ...
    public void StudyEnrollmentProjections_ToDto_Works()
    {
        ...
        var dto = StudyEnrollmentProjections.ToDto().Compile()(studyEnrollment);
    ...
    public void GroupMembershipProjections_ToDto_Works()
    {
        ...
        var dto = GroupMembershipProjections.ToDto(_userId, isBoard: true).Compile()(membership);
    ...
    public void MemberProjections_ToDto_Works()
    {
        ...
        var dto = MemberProjections.ToDto(_userId, isBoard: true).Compile()(member);
    ...
    public void EnrollmentProjections_ToDto_Works()
    {
        ...
        var dto = EnrollmentProjections.ToDto(_userId, isBoard: true, includeActivity: true).Compile()(enrollment);
    ...
    public void ActivityProjections_ToDto_Works()
    {
        ...
        var dto = ActivityProjections.ToDto(_userId, isBoard: true).Compile()(activity);
