...
public class RegisterSlideRepositoryTests : IDisposable
{
    ...
    private readonly RegisterSlideRepository _repository;
    private readonly Guid _userId = Guid.NewGuid();

    public RegisterSlideRepositoryTests()
    {
        ...
        _repository = new RegisterSlideRepository(
            _db,
            _permissionService,
            _fileCompressor,
            _storageService,
            _memoryCache,
            NullLogger<RegisterSlideRepository>.Instance
        );
    }
    ...
    public async Task GetRegisterSlides_ReturnsSortedSlides()
    {
        ...
        // Act
        var result = await _repository.GetRegisterSlides(CancellationToken.None);
    ...
    public async Task GetRegisterSlide_Found_ReturnsDto()
    {
        ...
        // Act
        var result = await _repository.GetRegisterSlide(10, CancellationToken.None);
    ...
    {
        // Act
        var result = await _repository.GetRegisterSlide(999, CancellationToken.None);
    ...
    public async Task CreateRegisterSlide_UserNotBoard_ThrowsUnauthorized()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.CreateRegisterSlide(dto, _userId, CancellationToken.None));
    }
    ...
    public async Task CreateRegisterSlide_ValidRequest_SavesCorrectly()
    {
        ...
        // Act
        var result = await _repository.CreateRegisterSlide(dto, _userId, CancellationToken.None);
    ...
    public async Task UpdateRegisterSlide_NotFound_ThrowsKeyNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.UpdateRegisterSlide(999, dto, _userId, CancellationToken.None));
    }
    ...
    public async Task UpdateRegisterSlide_UpdatesSortOrder()
    {
        ...
        // Act
        await _repository.UpdateRegisterSlide(1, dto, _userId, CancellationToken.None);
    ...
    public async Task DeleteRegisterSlide_RemovesFromDbAndStorage()
    {
        ...
        // Act
        await _repository.DeleteRegisterSlide(1, _userId, CancellationToken.None);
    ...
    public async Task UploadRegisterSlideImage_NullImage_ClearsImage()
    {
        ...
        // Act
        var result = await _repository.UploadRegisterSlideImage(1, _userId, null);
    ...
    public async Task UploadRegisterSlideImage_ValidImage_SavesAndDeletesOld()
    {
        ...
        // Act
        var result = await _repository.UploadRegisterSlideImage(1, _userId, formFile);
    ...
    public async Task UploadRegisterSlideImage_CompressThrows_RollsBackTransaction()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<InvalidOperationException>(() =>
            _repository.UploadRegisterSlideImage(1, _userId, formFile));
    ...
    public async Task GetRegisterSlideImageFile_Cached_ReturnsCachedFile()
    {
        ...
        // Act
        var result = await _repository.GetRegisterSlideImageFile("path.webp");
