...
public class MemberRepositoryTests : IDisposable
{
    ...
    public MemberRepositoryTests()
    {
        ...
        _repository = new MemberRepository(
            ...
            _authService,
            _memoryCache,
            NullLogger<MemberRepository>.Instance
        );
    }
    ...
    public async Task GetMembers_AsBoard_ReturnsMembers()
    {
        ...
        // Act
        var result = await _repository.GetMembers(dto, _userId, CancellationToken.None);
    ...
    public async Task GetMember_Self_ReturnsMember()
    {
        ...
        // Act
        var result = await _repository.GetMember(_userId, _userId, CancellationToken.None);
    ...
    public async Task GetMember_OtherAsBoard_ReturnsMember()
    {
        ...
        // Act
        var result = await _repository.GetMember(otherId, _userId, CancellationToken.None);
    ...
    public async Task CreateMember_BegunstigerWithoutUser_ThrowsUnauthorized()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.CreateMember(dto, null, CancellationToken.None));
    }
    ...
    public async Task CreateMember_BegunstigerNotBoard_ThrowsUnauthorized()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.CreateMember(dto, _userId, CancellationToken.None));
    }
    ...
    public async Task CreateMember_ValidRequest_SavesMember()
    {
        ...
        // Act
        var result = await _repository.CreateMember(dto, _userId, CancellationToken.None);
    ...
    public async Task DeleteMember_WithUnpaidActivities_ThrowsInvalidOperationException()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(() =>
            _repository.DeleteMember(member.Id, _userId, CancellationToken.None));
    }
    ...
    public async Task DeleteMember_ValidRequest_RemovesFromDbAndStorage()
    {
        ...
        // Act
        await _repository.DeleteMember(memberId, _userId, CancellationToken.None);
    ...
    public async Task PatchMember_RestrictedFieldBySelf_ThrowsUnauthorized()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.PatchMember(_userId, patchDoc, _userId, CancellationToken.None));
    }
    ...
    public async Task PatchMember_ValidRequest_UpdatesDb()
    {
        ...
        // Act
        await _repository.PatchMember(_userId, patchDoc, _userId, CancellationToken.None);
    ...
    public async Task UpdateMember_ValidRequest_UpdatesDb()
    {
        ...
        // Act
        await _repository.UpdateMember(_userId, dto, _userId, CancellationToken.None);
    ...
    public async Task DeleteProfilePicture_ValidRequest_ClearsPicture()
    {
        ...
        // Act
        await _repository.DeleteProfilePicture(_userId, _userId, CancellationToken.None);
    ...
    public async Task RefreshEmail_ValidRequest_SyncsWithAuthSystem()
    {
        ...
        // Act
        await _repository.RefreshEmail(authUserId, CancellationToken.None);
    ...
    public async Task RefreshEmail_MemberNotFound_ThrowsKeyNotFoundException()
    {
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.RefreshEmail(Guid.NewGuid(), CancellationToken.None));
    }
    ...
    public async Task PatchMember_MemberNotFound_ThrowsKeyNotFoundException()
    {
        var patchDoc = new JsonPatchDocument<Member>();
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.PatchMember(Guid.NewGuid(), patchDoc, _userId, CancellationToken.None));
    }
    ...
    public async Task UpdateMember_MemberNotFound_ThrowsKeyNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.UpdateMember(Guid.NewGuid(), dto, _userId, CancellationToken.None));
    }
    ...
    public async Task DeleteProfilePicture_MemberNotFound_ReturnsSilently()
    {
        ...
        await _repository.DeleteProfilePicture(Guid.NewGuid(), _userId, CancellationToken.None);
    }
    ...
    public async Task DeleteProfilePicture_NoPicture_ThrowsKeyNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.DeleteProfilePicture(_userId, _userId, CancellationToken.None));
    }
