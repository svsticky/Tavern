...
public class EnrollmentRepositoryTests : IDisposable
{
    ...
    public EnrollmentRepositoryTests()
    {
        ...
        _repository = new EnrollmentRepository(
            ...
            _paymentValidationService,
            _mailService,
            NullLogger<EnrollmentRepository>.Instance
        );
    }
    ...
    public async Task GetEnrollments_UserIsBoardMember_ReturnsFilteredEnrollments()
    {
        ...
        // Act
        var result = await _repository.GetEnrollments(dto, _userId, CancellationToken.None);
    ...
    public async Task GetEnrollments_UserIsNotBoardMemberAndRequestsOthers_EnsuresBoardPermission()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.GetEnrollments(dto, member1.Id, CancellationToken.None));
    }
    ...
    public async Task GetEnrollment_Found_ReturnsDto()
    {
        ...
        // Act
        var result = await _repository.GetEnrollment(activity.Id, member.Id, member.Id, CancellationToken.None);
    ...
    public async Task GetEnrollment_NotFound_ReturnsNull()
    {
        ...
        // Act
        var result = await _repository.GetEnrollment(999u, member.Id, member.Id, CancellationToken.None);
    ...
    public async Task GetEnrollment_UnauthorizedUser_ThrowsUnauthorizedException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.GetEnrollment(activity.Id, member2.Id, member1.Id, CancellationToken.None));
    }
    ...
    public async Task CreateEnrollment_MemberNotFound_ThrowsKeyNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.CreateEnrollment(dto, _userId, CancellationToken.None));
    }
    ...
    public async Task CreateEnrollment_ActivityNotFound_ThrowsKeyNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.CreateEnrollment(dto, member.Id, CancellationToken.None));
    }
    ...
    public async Task CreateEnrollment_EnrollableFalseButOpenDateInPast_SetsEnrollableTrueAndProceeds()
    {
        ...
        var result = await _repository.CreateEnrollment(dto, member.Id, CancellationToken.None);
    ...
    public async Task CreateEnrollment_DeadlinePassedButIsBoard_SavesEnrollment()
    {
        ...
        var result = await _repository.CreateEnrollment(dto, _userId, CancellationToken.None);
    ...
    public async Task CreateEnrollment_ExceedsParticipantLimit_GoesToWaitingList()
    {
        ...
        var result = await _repository.CreateEnrollment(dto, member2.Id, CancellationToken.None);
    ...
    public async Task DeleteEnrollment_NotOnWaitingList_PromotesNextFromWaitingListAndMails()
    {
        ...
        // Act
        await _repository.DeleteEnrollment(activity.Id, memberToDelete.Id, memberToDelete.Id, CancellationToken.None);
    ...
    {
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.DeleteEnrollment(999u, Guid.NewGuid(), _userId, CancellationToken.None));
    }
    ...
    public async Task DeleteEnrollment_DeadlinePassed_ThrowsUnauthorizedAccessException()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.DeleteEnrollment(activity.Id, member.Id, member.Id, CancellationToken.None));
    }
    ...
    public async Task DeleteEnrollment_DeleteOthersWithoutBoard_ThrowsUnauthorized()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.DeleteEnrollment(activity.Id, member2.Id, member1.Id, CancellationToken.None));
    }
    ...
    public async Task UpdateEnrollment_EnrollmentNotFound_ThrowsKeyNotFoundException()
    {
        var dto = new PostEnrollmentDTO { MemberId = Guid.NewGuid(), ActivityId = 1 };
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.UpdateEnrollment(dto, _userId, CancellationToken.None));
    }
    ...
    public async Task UpdateEnrollment_DeadlinePassed_ThrowsUnauthorizedAccessException()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.UpdateEnrollment(dto, member.Id, CancellationToken.None));
    }
    ...
    public async Task UpdateEnrollment_MembersUpdateOthers_ThrowsUnauthorizedAccessException()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.UpdateEnrollment(dto, member1.Id, CancellationToken.None));
    }
    ...
    public async Task UpdateEnrollment_ValidRequest_UpdatesSpecificationAnswers()
    {
        ...
        await _repository.UpdateEnrollment(dto, member.Id, CancellationToken.None);
    ...
    public async Task PatchEnrollment_NullPatchDoc_ThrowsArgumentNullException()
    {
        await Assert.ThrowsAsync<ArgumentNullException>(() =>
            _repository.PatchEnrollment(1u, Guid.NewGuid(), null!, _userId, CancellationToken.None));
    }
    ...
    public async Task PatchEnrollment_PatchId_ThrowsArgumentException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() =>
            _repository.PatchEnrollment(1u, Guid.NewGuid(), patchDoc, _userId, CancellationToken.None));
    }
    ...
    public async Task PatchEnrollment_DeadlinePassed_ThrowsUnauthorizedAccessException()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.PatchEnrollment(activity.Id, member.Id, patchDoc, member.Id, CancellationToken.None));
    }
    ...
    public async Task PatchEnrollment_MembersPatchOthers_ThrowsUnauthorizedAccessException()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.PatchEnrollment(activity.Id, member2.Id, patchDoc, member1.Id, CancellationToken.None));
    }
    ...
    public async Task PatchEnrollment_ValidRequest_AppliesChanges()
    {
        ...
        await _repository.PatchEnrollment(activity.Id, member.Id, patchDoc, member.Id, CancellationToken.None);
    ...
    public async Task PromoteFromWaitingList_PromotesInOrderAndChangesWaitingListStatus()
    {
        ...
        var result = await _repository.PromoteFromWaitingList(activity.Id, CancellationToken.None);
