...
public class MailinglistRepositoryTests : IDisposable
{
    ...
    public MailinglistRepositoryTests()
    {
        ...
        _repository = new MailinglistRepository(
            _db,
            _permissionService,
            NullLogger<MailinglistRepository>.Instance
        );
    }
    ...
    public async Task GetMailinglists_ReturnsAllMailinglists()
    {
        ...
        // Act
        var result = await _repository.GetMailinglists(CancellationToken.None);
    ...
    public async Task GetMailinglist_Found_ReturnsMailinglist()
    {
        ...
        // Act
        var result = await _repository.GetMailinglist(10, CancellationToken.None);
    ...
    {
        // Act
        var result = await _repository.GetMailinglist(999, CancellationToken.None);
    ...
    public async Task CreateMailinglist_UserNotBoard_ThrowsUnauthorized()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.CreateMailinglist(dto, _userId, CancellationToken.None));
    }
    ...
    public async Task CreateMailinglist_NoLists_SetsBitValueTo1()
    {
        ...
        // Act
        var result = await _repository.CreateMailinglist(dto, _userId, CancellationToken.None);
    ...
    public async Task UpdateMailinglist_MailinglistNotFound_ThrowsKeyNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.UpdateMailinglist(999, dto, _userId, CancellationToken.None));
    }
    ...
    public async Task UpdateMailinglist_MailinglistExists_UpdatesDatabase()
    {
        ...
        // Act
        await _repository.UpdateMailinglist(100, dto, _userId, CancellationToken.None);
    ...
    public async Task DeleteMailinglist_MailinglistExists_RemovesAndClearsMemberSubscriptions()
    {
        ...
        // Act
        await _repository.DeleteMailinglist(5, _userId, CancellationToken.None);
    ...
    public async Task PatchMailinglist_NullPatch_ThrowsArgumentException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() =>
            _repository.PatchMailinglist(1, null!, _userId, CancellationToken.None));
    }
    ...
    public async Task PatchMailinglist_ModifiesRestrictedFields_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<ArgumentException>(() =>
            _repository.PatchMailinglist(1, patchDoc, _userId, CancellationToken.None));
    }
    ...
    public async Task PatchMailinglist_ValidPatch_UpdatesDatabase()
    {
        ...
        // Act
        await _repository.PatchMailinglist(20, patchDoc, _userId, CancellationToken.None);
