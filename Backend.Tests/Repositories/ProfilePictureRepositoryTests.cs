...
public class ProfilePictureRepositoryTests : IDisposable
{
    ...
    public ProfilePictureRepositoryTests()
    {
        ...
        _repository = new ProfilePictureRepository(
            _db,
            _storageService,
            _permissionService,
            _fileCompressor,
            _memoryCache,
            NullLogger<ProfilePictureRepository>.Instance
        );
    }
    ...
    public async Task GetProfilePictureByPath_CacheHit_ReturnsFromCache()
    {
        ...
        // Act
        var result = await _repository.GetProfilePictureByPath(path);
    ...
    public async Task UploadProfilePicture_MemberNotFound_ThrowsException()
    {
        ...
        await Assert.ThrowsAsync<Exception>(() =>
            _repository.UploadProfilePicture(Guid.NewGuid(), _userId, null));
    }
    ...
    public async Task UploadProfilePicture_DifferentUserNotBoard_ThrowsUnauthorized()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.UploadProfilePicture(memberId, _userId, null));
    }
    ...
    public async Task UploadProfilePicture_NullImage_ClearsProfilePicture()
    {
        ...
        // Act
        var result = await _repository.UploadProfilePicture(memberId, memberId, null);
    ...
    public async Task UploadProfilePicture_ValidImage_CompressesAndSaves()
    {
        ...
        // Act
        var result = await _repository.UploadProfilePicture(memberId, memberId, formFile);
