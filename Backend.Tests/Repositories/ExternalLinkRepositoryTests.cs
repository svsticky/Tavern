...
public class ExternalLinkRepositoryTests : IDisposable
{
    ...
    private readonly ExternalLinkRepository _repository;
    private readonly Guid _userId = Guid.NewGuid();

    public ExternalLinkRepositoryTests()
    {
        ...
        _repository = new ExternalLinkRepository(
            _db,
            _permissionService,
            _fileCompressor,
            _storageService,
            _memoryCache,
            NullLogger<ExternalLinkRepository>.Instance
        );
    }
    ...
    public async Task GetExternalLinks_ReturnsSortedLinks()
    {
        ...
        // Act
        var result = await _repository.GetExternalLinks(CancellationToken.None);
    ...
    public async Task GetExternalLink_Found_ReturnsDto()
    {
        ...
        // Act
        var result = await _repository.GetExternalLink(10, CancellationToken.None);
    ...
    {
        // Act
        var result = await _repository.GetExternalLink(999, CancellationToken.None);
    ...
    public async Task CreateExternalLink_UserNotBoard_ThrowsUnauthorized()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.CreateExternalLink(dto, _userId, CancellationToken.None));
    }
    ...
    public async Task CreateExternalLink_WithSortOrder_SavesCorrectly()
    {
        ...
        // Act
        var result = await _repository.CreateExternalLink(dto, _userId, CancellationToken.None);
    ...
    public async Task UpdateExternalLink_NotFound_ThrowsKeyNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.UpdateExternalLink(999, dto, _userId, CancellationToken.None));
    }
    ...
    public async Task UpdateExternalLink_UpdatesFields()
    {
        ...
        // Act
        await _repository.UpdateExternalLink(1, dto, _userId, CancellationToken.None);
    ...
    public async Task DeleteExternalLink_RemovesFromDbAndStorage()
    {
        ...
        // Act
        await _repository.DeleteExternalLink(1, _userId, CancellationToken.None);
    ...
    public async Task UploadExternalLinkIcon_NullIcon_ClearsIcon()
    {
        ...
        // Act
        var result = await _repository.UploadExternalLinkIcon(1, _userId, null);
    ...
    public async Task UploadExternalLinkIcon_ValidIcon_SavesAndDeletesOld()
    {
        ...
        // Act
        var result = await _repository.UploadExternalLinkIcon(1, _userId, formFile);
    ...
    public async Task UploadExternalLinkIcon_CompressThrows_RollsBackTransaction()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(() =>
            _repository.UploadExternalLinkIcon(1, _userId, formFile));
    ...
    public async Task GetExternalLinkIconFile_Cached_ReturnsCachedFile()
    {
        ...
        // Act
        var result = await _repository.GetExternalLinkIconFile("path.webp");
