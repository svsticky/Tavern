...
public class RoleAliasRepositoryTests : IDisposable
{
    ...
    private readonly RoleAliasRepository _repository;
    private readonly Guid _userId = Guid.NewGuid();

    public RoleAliasRepositoryTests()
    {
        ...
        _repository = new RoleAliasRepository(
            _db,
            _permissionService,
            _authOutboxWorker,
            NullLogger<RoleAliasRepository>.Instance
        );
    }
    ...
    public async Task GetRoleAliases_ReturnsAllRoleAliases()
    {
        ...
        // Act
        var result = await _repository.GetRoleAliases(CancellationToken.None);
    ...
    public async Task GetRoleAlias_Found_ReturnsRoleAlias()
    {
        ...
        // Act
        var result = await _repository.GetRoleAlias(10, CancellationToken.None);
    ...
    {
        // Act
        var result = await _repository.GetRoleAlias(999, CancellationToken.None);
    ...
    public async Task CreateRoleAlias_UserNotBoard_ThrowsUnauthorized()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.CreateRoleAlias(dto, _userId, CancellationToken.None));
    }
    ...
    public async Task CreateRoleAlias_ValidData_CreatesRoleAlias()
    {
        ...
        // Act
        var result = await _repository.CreateRoleAlias(dto, _userId, CancellationToken.None);
    ...
    public async Task DeleteRoleAlias_AliasNotFound_ThrowsException()
    {
        // Act & Assert
        await Assert.ThrowsAsync<Exception>(() =>
            _repository.DeleteRoleAlias(999u, _userId, CancellationToken.None));
    }
    ...
    public async Task DeleteRoleAlias_AliasExists_DeletesAndQueuesSync()
    {
        ...
        // Act
        await _repository.DeleteRoleAlias(15u, _userId, CancellationToken.None);
    ...
    public async Task PatchRoleAlias_NullPatch_ThrowsException()
    {
        // Act & Assert
        await Assert.ThrowsAsync<Exception>(() =>
            _repository.PatchRoleAlias(1u, null!, _userId, CancellationToken.None));
    }
    ...
    public async Task PatchRoleAlias_ModifiesRestrictedFields_ThrowsArgumentException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() =>
            _repository.PatchRoleAlias(1u, patchDoc, _userId, CancellationToken.None));
    }
    ...
    public async Task PatchRoleAlias_ValidPatch_UpdatesAndQueuesSync()
    {
        ...
        // Act
        await _repository.PatchRoleAlias(20u, patchDoc, _userId, CancellationToken.None);
    ...
    public async Task UpdateRoleAlias_AliasExists_UpdatesAndQueuesSync()
    {
        ...
        // Act
        await _repository.UpdateRoleAlias(30u, dto, _userId, CancellationToken.None);
