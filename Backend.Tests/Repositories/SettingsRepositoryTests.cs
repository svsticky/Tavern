...
public class SettingsRepositoryTests : IDisposable
{
    ...
    public async Task GetSettings_EnsuresBoardMember_AndReturnsAllSettings()
    {
        ...
        // Act
        var result = await _repository.GetSettings(_userId, CancellationToken.None);
    ...
    public async Task GetSetting_WithOpenSetting_DoesNotRequireAuthorization()
    {
        ...
        // Act
        var result = await _repository.GetSetting(settingName, null, CancellationToken.None);
    ...
    public async Task GetSetting_WithClosedSetting_AndNoUserId_ThrowsUnauthorizedAccessException()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(async () =>
            await _repository.GetSetting(settingName, null, CancellationToken.None));
    }
    ...
    public async Task GetSetting_WithClosedSetting_AndValidUserId_EnsuresBoardMember_AndReturnsSetting()
    {
        ...
        // Act
        var result = await _repository.GetSetting(settingName, _userId, CancellationToken.None);
    ...
    public async Task CreateSetting_EnsuresBoardMember_AddsToDb_AndReturnsSetting()
    {
        ...
        // Act
        var result = await _repository.CreateSetting(name, value, _userId, CancellationToken.None);
    ...
    public async Task UpdateSetting_EnsuresBoardMember_AndUpdatesValue()
    {
        ...
        // Act
        await _repository.UpdateSetting(name, "NewValue", _userId, CancellationToken.None);
    ...
    public async Task DeleteSetting_EnsuresBoardMember_AndRemovesFromDb()
    {
        ...
        // Act
        await _repository.DeleteSetting(name, _userId, CancellationToken.None);
    ...
    public async Task DeleteSetting_WhenNotFound_ThrowsKeyNotFoundException()
    {
        ...
        var exception = await Assert.ThrowsAsync<KeyNotFoundException>(async () =>
            await _repository.DeleteSetting("NonExistent", _userId, CancellationToken.None));
    ...
    public async Task PatchSetting_EnsuresBoardMember_AppliesPatchSuccessfully()
    {
        ...
        // Act
        await _repository.PatchSetting(name, patchDoc, _userId, CancellationToken.None);
    ...
    public async Task PatchSetting_WhenPatchDocNull_ThrowsArgumentException()
    {
        ...
        var exception = await Assert.ThrowsAsync<ArgumentException>(async () =>
            await _repository.PatchSetting(name, null!, _userId, CancellationToken.None));
