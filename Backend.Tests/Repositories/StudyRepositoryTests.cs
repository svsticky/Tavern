...
public class StudyRepositoryTests : IDisposable
{
    ...
    public StudyRepositoryTests()
    {
        ...
        _repository = new StudyRepository(
            _db,
            _permissionService,
            NullLogger<StudyRepository>.Instance
        );
    }
    ...
    public async Task GetStudies_ReturnsAllStudies()
    {
        ...
        // Act
        var result = await _repository.GetStudies(CancellationToken.None);
    ...
    public async Task GetStudy_Found_ReturnsStudy()
    {
        ...
        // Act
        var result = await _repository.GetStudy(10, CancellationToken.None);
    ...
    {
        // Act
        var result = await _repository.GetStudy(999, CancellationToken.None);
    ...
    public async Task CreateStudy_UserNotBoard_ThrowsUnauthorized()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.CreateStudy(dto, _userId, CancellationToken.None));
    }
    ...
    public async Task CreateStudy_ValidData_CreatesStudy()
    {
        ...
        // Act
        var result = await _repository.CreateStudy(dto, _userId, CancellationToken.None);
    ...
    public async Task DeleteStudy_UserNotBoard_ThrowsUnauthorized()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.DeleteStudy(1u, _userId, CancellationToken.None));
    }
    ...
    public async Task DeleteStudy_StudyNotFound_ThrowsException()
    {
        ...
        await Assert.ThrowsAsync<Exception>(() =>
            _repository.DeleteStudy(999u, _userId, CancellationToken.None));
    }
    ...
    public async Task DeleteStudy_StudyExists_RemovesFromDatabase()
    {
        ...
        // Act
        await _repository.DeleteStudy(15u, _userId, CancellationToken.None);
    ...
    public async Task PatchStudy_NullPatch_ThrowsException()
    {
        // Act & Assert
        await Assert.ThrowsAsync<Exception>(() =>
            _repository.PatchStudy(1u, null!, _userId, CancellationToken.None));
    }
    ...
    public async Task PatchStudy_ModifiesId_ThrowsArgumentException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() =>
            _repository.PatchStudy(1u, patchDoc, _userId, CancellationToken.None));
    }
    ...
    public async Task PatchStudy_StudyNotFound_ThrowsException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<Exception>(() =>
            _repository.PatchStudy(999u, patchDoc, _userId, CancellationToken.None));
    }
    ...
    public async Task PatchStudy_ValidPatch_UpdatesDatabase()
    {
        ...
        // Act
        await _repository.PatchStudy(20u, patchDoc, _userId, CancellationToken.None);
    ...
    public async Task UpdateStudy_StudyNotFound_ThrowsException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<Exception>(() =>
            _repository.UpdateStudy(999u, dto, _userId, CancellationToken.None));
    }
    ...
    public async Task UpdateStudy_StudyExists_UpdatesDatabase()
    {
        ...
        // Act
        await _repository.UpdateStudy(30u, dto, _userId, CancellationToken.None);
