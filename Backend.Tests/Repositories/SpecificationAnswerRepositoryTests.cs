...
public class SpecificationAnswerRepositoryTests : IDisposable
{
    private readonly DbContextOptions<PostgresDbContext> _dbOptions;
    private readonly IPermissionService _permissionService;
    private readonly SpecificationAnswerRepository _repository;
    private readonly PostgresDbContext _db;

    public SpecificationAnswerRepositoryTests()
    {
        ...
        _repository = new SpecificationAnswerRepository(
            _db,
            _permissionService,
            NullLogger<SpecificationAnswerRepository>.Instance
        );
    }
    ...
    public async Task PatchSpecificationAnswersAsync_OtherUserNotBoard_ThrowsUnauthorized()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.PatchSpecificationAnswersAsync(memberId, 1, patchDoc, otherUserId));
    }
    ...
    public async Task PatchSpecificationAnswersAsync_PatchDocNull_ThrowsArgumentException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() =>
            _repository.PatchSpecificationAnswersAsync(memberId, 1, null!, memberId));
    }
    ...
    public async Task PatchSpecificationAnswersAsync_ModifiesRestrictedFields_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<ArgumentException>(() =>
            _repository.PatchSpecificationAnswersAsync(memberId, 1, patchDoc, memberId));
    }
    ...
    public async Task PatchSpecificationAnswersAsync_AnswerNotFound_ThrowsKeyNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            _repository.PatchSpecificationAnswersAsync(memberId, 999, patchDoc, memberId));
    }
    ...
    public async Task PatchSpecificationAnswersAsync_DifferentAnswerOwner_ThrowsUnauthorized()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _repository.PatchSpecificationAnswersAsync(Guid.NewGuid(), 1, patchDoc, Guid.NewGuid()));
    }
    ...
    public async Task PatchSpecificationAnswersAsync_SuccessfulPatch_UpdatesDatabase()
    {
        ...
        // Act
        await _repository.PatchSpecificationAnswersAsync(memberId, 1, patchDoc, memberId);
